...
def a_star_search(graph, start, goal, heuristic):
    ...
    while not frontier.empty():
        _, current_node = frontier.get()  # Mengambil simpul dengan prioritas terendah
        ...
        if current_node in explored:
            continue  # Jika simpul sudah dieksplorasi, lanjutkan ke iterasi berikutnya

        explored.add(current_node)  # Tandai simpul sebagai sudah dieksplorasi

        for neighbor, weight in graph[current_node].items():
            new_cost = cost[current_node] + weight  # g(n) = biaya dari start ke neighbor
